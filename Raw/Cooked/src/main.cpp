...
pros::Rotation horizontal_tracker(20);
// vertical tracking wheel encoder
pros::adi::Encoder vertical_tracker('C', 'D', true);
// horizontal tracking wheel
lemlib::TrackingWheel horizontal_tracking_wheel(&horizontal_tracker, lemlib::Omniwheel::NEW_275, -5.75);
...
void initialize() {
	...
	// 	pros::delay(1000); // Wait for the LCD to initialize
	// 	autonomous(); // Call the autonomous function to run the autonomous code
	// }
}
